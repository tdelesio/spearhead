...
<Separator className='pt-5'/>
  ...
  <section className="mb-6">
    ...
    <p className="text-gray-700 leading-relaxed">
      I built this app to help with running Warhammer AoS Spearhead games. I found it difficult to manage abilities. Some of them are one-time use, others can be applied only during specific rounds, and they are located on the Battle Traits, Regiment Abilities, and Enhancements as well as on Battle Tome cards. All of this is hard to keep track of, and most of the time I miss abilities that I could have used. The idea of this app is to manage yourself and the faction you're playing with (not the game itself). The phases are broken down just like the game expects. You can either swipe to the next phase or click the arrow button on the navigation at the top. If you click home, it resets all your choices and lets you start over. I added a Victory Point track that appears on the End stage to help you keep track of that. The Next Round button will go back to start and advance the next round. Eventually, I will be adding logic to help with some abilities.
    </p>
  </section>
